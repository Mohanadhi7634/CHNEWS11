...
export const Sports = () => {
  ...
  useEffect(() => {
   ...
   const Sports = async () => {
    try {
      const response = await axios.get('https://newsappbe.onrender.com/user/getSports');
   ...
   const Sports1 = async () => {
    try {
      const response = await axios.get('https://newsappbe.onrender.com/user/getSports/five');
      const Data = response.data.data;
      setData1(Data);
      setIsLoading(false);
      //console.log(Data); 
                      ...
                      <div class="card-body">
                        ...
                        <div class="row ">
                          ...
                          {dataShow.map((item, index) => (
                              <div class="row CardSports CardImg" onClick={()=> GetById(item._id)}  key={index} >
