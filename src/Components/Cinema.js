...
export const Cinema = () => {
  ...
  useEffect(() => {
   ...
   const Cinema = async () => {
    try {
      const response = await axios.get('https://newsappbe.onrender.com/user/getCinema');
   ...
   const Cinema1 = async () => {
    try {
      const response = await axios.get('https://newsappbe.onrender.com/user/getCinema/five');
      const Data = response.data.data;
      setData1(Data);
      setIsLoading(false);
     // console.log(Data); 
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        {dataShow.map((item, index) => (
                            <div class="row CardCinema CardImg" onClick={()=>GetById(item._id)}  key={index}  >
