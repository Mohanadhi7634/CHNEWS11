...
export const Tech = () => {
  ...
  useEffect(() => {
   ...
   const Tech = async () => {
    try {
      const response = await axios.get('https://newsappbe.onrender.com/user/getTech');
   ...
   const tech1 = async () => {
    try {
      const response = await axios.get('https://newsappbe.onrender.com/user/getTech/five');
      const Data = response.data.data;
      setData1(Data);
      setIsLoading(false);
     // console.log(Data);
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        {dataShow.map((item, index) => (
                            <div class="row CardTech CardImg" onClick={()=>GetById(item._id)} key={index} >
